...
os.system("clear");print("\n\t join our Whatsapp group 🥵🔥");time.sleep(1)
os.system('xdg-open https://chat.whatsapp.com/E9G45DzibkCJe42rCnaiKi');time.sleep(5)
os.system("clear");print("\n\t join our facebook group 💚💬");time.sleep(3)
os.system('xdg-open https://facebook.com/groups/161900626963409/')
...
{R2} ║  ╠╦╝╠═╣╔═╝╚╦╝  ║  ║ ║ ║║║╣ ╠╦╝╚═╗
{R2} ╚═╝╩╚═╩ ╩╚═╝ ╩   ╚═╝╚═╝═╩╝╚═╝╩╚═╚═╝
{R2} Author   : Muhammad Younis
{R2} Github   : https://github.com/YounisXyz
{R2} Facebook : www.facebook.com/xyzhackers""",subtitle=f"1.0.0",title=f"{B2}{XyzTimeZone()}",width=80,padding=(0,4),style=f"#FFFFFF"))
...
def YounisXyz():
			...
			if xd in ['1','01']:
				...
				younisxyz.append(Panel(f"Method {H2}for mix ids{P2}",title=f"{R2}01{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
				younisxyz.append(Panel(f"Method {H2}for mix ids{P2}",title=f"{R2}02{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
				younisxyz.append(Panel(f"Method {H2}fast",title=f"{R2}03{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				younisxyz.append(Panel(f"Method {H2}for new ids best",title=f"{R2}04{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				younisxyz.append(Panel(f"Method {H2}for new ids slow",title=f"{R2}05{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				younisxyz.append(Panel(f"Method {H2}for new ids",title=f"{R2}06{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				younisxyz.append(Panel(f"Method {H2}for new ids",title=f"{R2}07{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				younisxyz.append(Panel(f"Method {H2}for new ids",title=f"{R2}08{P2}",width=27,padding=(0,6),style=f"#FFFFFF"))
				younisjohn.print(Columns(younisxyz))
				...
				os.system('xdg-open https://www.facebook.com/xyzhackers');time.sleep(2)
				YounisXyz()
			else:
				print('\n\t\033[0;91m Option not found!');time.sleep(2);YounisXyz()
...
def pak():
		...
		younis_xyz.append(Panel(f"Method {H2}Best{P2}",title=f"{R2}01{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		younis_xyz.append(Panel(f"Method {H2}Fast{P2}",title=f"{R2}02{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		younis_xyz.append(Panel(f"Method {H2}v.best{P2}",title=f"{R2}03{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		younis_xyz.append(Panel(f"Method {P2}",title=f"{R2}04{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		younis_xyz.append(Panel(f"Method {H2}Slow{P2}",title=f"{R2}05{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		younis_xyz.append(Panel(f"Method {H2}Slow{P2}",title=f"{R2}06{P2}",width=25,padding=(0,4),style=f"#FFFFFF"))
		younis_john.print(Columns(younis_xyz))
		...
		with tred(max_workers=30) as XYZ:	
			...
			younis_john.print(Columns(pornhubxyz))
			print()
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
